...
const allMarkets = [
  ...
  { symbol: 'JUMP10', name: 'Jump 10 Index', price: 1050.20, change: 0.4, category: 'Derived', volatility: 'High' },
  { symbol: 'JUMP25', name: 'Jump 25 Index', price: 2100.45, change: -0.8, category: 'Derived', volatility: 'High' },
  ...
  // Indices
  { symbol: 'OTCS_SPX500', name: 'S&P 500', price: 5200.50, change: 1.2, category: 'Indices', volatility: 'Medium' },
  { symbol: 'OTCS_NDX100', name: 'Nasdaq 100', price: 18200.30, change: 1.5, category: 'Indices', volatility: 'High' },
  { symbol: 'OTCS_DJI', name: 'Dow Jones', price: 39100.20, change: 0.8, category: 'Indices', volatility: 'Medium' },
];
